<template>
  <main class="orchestrate">
    <section class="hero">
      <div class="grid">
        <div class="media">
          <NuxtImg src="/landing/company/teams/team.png" alt="Team Image" class="image" width="686" height="456" />
        </div>
        <div class="content">
          <h1 class="title">
          ...
          <p class="text">
            ...
            challenging the status quo and traditional limitations. Kestra
            empowers engineers to orchestrate any workflow, in any
            language, on any infrastructure, delivering unparalleled freedom
            and flexibility. By simplifying complexity and eliminating
            constraints, we enable developers to build faster, and collaborate
...
.orchestrate {
  ...
  .hero {
    ...
    @include media-breakpoint-up(md) { padding: 33px 64px 170px; }
    @include media-breakpoint-up(xxl) { padding: 133px 12rem 170px; }
    ...
    .grid {
      ...
      .media {
        ...
        border: 1px solid;
        border-image-source: linear-gradient(91.19deg, #474450 1.02%, rgba(55, 53, 63, 0.37) 66.77%);
        ...
        @media (max-width: 1399px) { order: 2; }
...
;
        ...
        .title {
          ...
          @include media-breakpoint-down(md) { font-size: $h2-font-size; }
        }
        ...
        .text {
          ...
          @include media-breakpoint-down(sm) { font-size: $font-size-sm; padding: 0; }
        }
      }
  ...
  .trust {
    ...
    &::before {
      ...
      height: 564px;
      background:
        linear-gradient(179.47deg, rgba(102, 108, 133, 0) 5.43%, rgba(24, 25, 31, 0.3) 49.42%, rgba(102, 108, 133, 0) 98.04%),
    ...
    .container {
      ...
      @include media-breakpoint-up(lg) { padding: 0 40px; }
      @include media-breakpoint-up(xl) { padding: 0 80px; }
      @include media-breakpoint-up(xxl) { padding: 0 150px; }
    }
