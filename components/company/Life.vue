...
.container {
  position: relative;
  min-height: 1473px;
  background: url('/landing/company/teams/Background.svg') no-repeat top center;
  background-size: auto;
  max-width: 100%;
  padding: $rem-5 $rem-1;

  @include media-breakpoint-up(sm) { padding: $rem-4 $rem-2; }
  @include media-breakpoint-up(md) { padding: 4.5rem $rem-4; }
  ...
  .brand-card {
    ...
    .info {
      ...
      .label {
        font: 500 #{$font-size-sm}/1.5 "Source Code Pro", monospace;
        color: #CD88FF;
      ...
      .title {
        ...
        @include media-breakpoint-down(md) { font-size: 28px; }
      ...
      .text {
        ...
        @include media-breakpoint-down(sm) { font-size: $font-size-sm; }
    ...
    .media {
      ...
      .img {
        ...
        @media (max-width: 1140px) { width: 300px; height: 242px; }
        @include media-breakpoint-down(xl) { width: 300px; height: 242px; margin-left: 3rem;}
        @include media-breakpoint-down(lg) { width: 250px; height: 202px; }
        @include media-breakpoint-down(md) { width: 200px; height: 161px; }
      }
    }
  }
}
